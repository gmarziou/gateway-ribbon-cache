...
@EnableEurekaClient
@EnableZuulProxy
public class RibbonCacheApp {

    private static final Logger log = LoggerFactory.getLogger(RibbonCacheApp.class);

    @Inject
    private Environment env;

    /**
     * Initializes ribbon_cache.
     * <p>
    ...
    public static void main(String[] args) throws UnknownHostException {
        SpringApplication app = new SpringApplication(RibbonCacheApp.class);
