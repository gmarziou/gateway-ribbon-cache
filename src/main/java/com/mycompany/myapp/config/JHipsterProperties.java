...
public class JHipsterProperties {
    ...
    public static class Mail {
        ...
        private String from = "ribbon_cache@localhost";
    ...
    public static class Swagger {
        ...
        private String title = "ribbon_cache API";

        private String description = "ribbon_cache API documentation";
    ...
    public static class Metrics {
        ...
        public static class Graphite {
            ...
            private String prefix = "ribbon_cache";
